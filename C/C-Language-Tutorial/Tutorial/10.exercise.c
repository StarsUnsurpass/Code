...
void extractUinqueWords(const char* text, char uniqueWords[][WORD_SIZE], int* uniqueCount);
...
int main4(void) {
	...
	extractUinqueWords(replacedText, uniqueWords, &uniqueCount);
	puts("Unique words:");
